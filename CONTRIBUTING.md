...
## Open an issue and fork the repository
 ...
 - Clone the forked repository to your local development machine
   (e.g. `git clone git@github.com:<YOUR_GITHUB_USER>/animation_tools.git`).
...
### Open a pull request
Go to the [pull request page of AnimationTools][PRs] and in the top
...
[GitHub issue]: https://github.com/signmotion/animation_tools/issues/new
[GitHub issues]: https://github.com/signmotion/animation_tools/issues/new
